set("dart_utils_DEPENDENCIES" dart)
set("dart_utils_LIBRARIES" dart-utils)

set_property(DIRECTORY PROPERTY "DART_utils_FOUND" TRUE)
foreach(external_dep tinyxml2)
  ...
  if(NOT ${external_dep}_FOUND AND NOT ${EXTERNAL_DEP_UPPER}_FOUND)
    set_property(DIRECTORY PROPERTY DART_utils_FOUND FALSE)
    if(NOT DART_FIND_QUIETLY)
      message(WARNING
        "Cannot retrieve dart-utils because the dependency "
